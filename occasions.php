...
<html class="wide wow-animation" lang="fr">
  ...
  <body>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-scroll-holder">
                    <ul class="rd-navbar-nav">
                      ...
                      <!--<li><a href="#">VEHICULES<br> DE DIRECTION</a>
                      </li>-->
                      <li><a href="he.php">HYBRIDES ET<br> ELECTRIQUES</a>
                      </li>
                      <!--<li><a href="#">FINANCEMENT<br> VOITURE</a>
                      </li>-->
                    </ul>
                  </div>
                </div>
        ...
        <div class="shell shell-fluid">
          <div class="range range-xs-center">
            <div class="cell-xs-12 cell-xl-11">
              <h2 class="text-white">DÉCOUVREZ NOS OFFRES D'OCCASION</h2>
              <ul class="breadcrumbs-custom">
                <li><a href="index.php">ACCUEIL</a></li>
                <li class="active">VOITURES D'OCCASIONS</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="cars_board">  
      <div class="col-md-2">
        <h6><i class="fa-angle-double-right">Toutes nos marques de voitures d'occasion</i></h6>
      </div>
        ...
        <section class="">
          <div class="shell">
            <div class="range range-30" data-lightgallery="group">
              <?php
                $sql= $cnx->prepare("SELECT * FROM cars WHERE categorie = 'occasion'");
                $req = $sql->execute();
              ...
              <div class="col-sm-6 col-md-3 carac-box">
                <a href="cardetail.php?id=<?php echo $data['id'] ?>">
                  <div class="thumbnail-classic">
                    ...
                    <div class="caption" style="padding-right: 20px; padding-left: 20px; padding-top: 50px;padding-bottom: 20px;">
                      ...
                      <div class="col-md-12 carac-div"><h5><?php echo $data['marque']; ?></h5><span class="to-right backgrounded-1 very-small">OCCASION</span><h6><?php echo $data['modele'];?></h6>
                      <p></p>
                    </div>
