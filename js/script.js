...
function appearfn(){
	document.getElementById("satisr").style.display='none';
	document.getElementById("rvsn").style.display='none';
	document.getElementById("fncm").style.display='initial';
	document.getElementById("irvsn").style.display='none';
	document.getElementById("iasr").style.display='none';
	document.getElementById("ifncm").style.display='initial';
	
}

function appearrv(){
	document.getElementById("satisr").style.display='none';
	document.getElementById("rvsn").style.display='initial';
	document.getElementById("fncm").style.display='none';
	document.getElementById("irvsn").style.display='initial';
	document.getElementById("ifncm").style.display='none';
	document.getElementById("iasr").style.display='none';
}

function appearsr(){
	document.getElementById("satisr").style.display='initial';
	document.getElementById("rvsn").style.display='none';
	document.getElementById("fncm").style.display='none';
	document.getElementById("iasr").style.display='initial';
	document.getElementById("irvsn").style.display='none';
	document.getElementById("ifncm").style.display='none';
}

function slideun(){
	document.getElementById("slide-1").style.display='initial';
	document.getElementById("slide-2").style.display='none';
}

function slidedeux(){
	document.getElementById("slide-2").style.display='initial';
