...
if (array_key_exists('a_email', $_POST)) {
    ...
    $mail->setFrom($_POST['a_email'], 'First Last');
    ...
    if ($mail->addReplyTo($_POST['email'], $_POST['name'])) {
        ...
        $mail->Body = <<<EOT
        Message: {$_POST['email']}+{$_POST['a_marque']}+{$_POST['a_modele']}+{$_POST['a_prix']}+{$_POST['a_nom']}+{$_POST['a_nom']}+{$_POST['a_prenom']}+{$_POST['a_phon']}
EOT;
