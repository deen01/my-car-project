...
<html class="wide wow-animation" lang="fr">
  <head>
    <!-- Site Title-->
    <title>Voitures Hybrides et Electriques</title>
  ...
  <body>
        ...
        <div class="shell shell-fluid">
          <div class="range range-xs-center">
            <div class="cell-xs-12 cell-xl-11">
              <h2 class="text-white">VOITURES HYBRIDES ET ÉLECTRIQUES</h2>
              <ul class="breadcrumbs-custom">
                <li><a href="index.php">ACCUEIL</a></li>
                <li class="active">HYBRIDES ET ÉLECTRIQUES</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="cars_board">  
      <div class="col-md-2">
        <h6><i class="fa-angle-double-right">Toutes nos marques de voitures électriques</i></h6>
      </div>
        ...
        <section class="">
          <div class="shell">
            <div class="range range-30" data-lightgallery="group">
              <?php
                $sql= $cnx->prepare("SELECT * FROM cars WHERE carburant = 'Electrique'");
                $req = $sql->execute();
